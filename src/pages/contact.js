                  ...
                  <div className="uk-grid uk-child-width-1-2@m" data-uk-grid="">
                    ...
                    <div className="uk-panel">
                      <ul className="uk-list">
                        <li>
                          <a href="tel:123-456-7890" className="uk-link-reset">
                            123-456-7890
                          </a>
                        </li>
                        <li>
                          <a
                            href="mailto:support@nftmarket.com"
                            className="uk-link-reset"
                          >
                            support@nftmarket.com
                          </a>
                        </li>
                      ...
                      <ul className="uk-subnav uk-subnav-small uk-margin-top uk-text-gray-70 dark:uk-text-gray-40">
                        <li>
                          ...
                          >
                            <i className="uk-icon-small brand-twitter"></i>
                          </a>
                        </li>
                        <li>
                          <a
                          ...
                          >
                            <i className="uk-icon-small brand-facebook"></i>
                          </a>
                        </li>
                        <li>
                          <a
                          ...
                          >
                            <i className="uk-icon-small brand-snapchat"></i>
                          </a>
                        </li>
                        <li>
                          <a
                          ...
                          >
                            <i className="uk-icon-small brand-youtube-play"></i>
                          </a>
                        </li>
                        <li>
                          <a
                          ...
                          >
                            <i className="uk-icon-small brand-reddit-alien"></i>
                          </a>
                        </li>
                        <li>
                          <a
                          ...
                          >
                            <i className="uk-icon-small brand-quora"></i>
                          </a>
                        </li>
                      </ul>
                    </div>
