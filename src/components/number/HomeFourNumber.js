        ...
        <div id="uni_numbers" className="uni-numbers uk-section uk-section-large@m">
            <div className="uk-container">
                <div className="uk-panel">
                    ...
                    <div className="uk-grid uk-grid-large uk-grid-divider uk-child-width-expand@m uk-text-center" data-uk-grid="" data-anime="targets: > *; opacity:[0, 1]; scale:[0.5, 1]; onview: -250; delay: anime.stagger(100);">
                        <div>
                            <div className="uk-panel">
                                <h4 className="uk-h3 uk-h1@m uk-margin-xsmall uk-margin@m">400k+</h4>
                                <span>Wallets Connected</span>
                            </div>
                        </div>
                        <div>
                            <div className="uk-panel">
                                <h4 className="uk-h3 uk-h1@m uk-margin-xsmall uk-margin@m">20k+</h4>
                                <span>Collections droped.</span>
                            </div>
                        </div>
                        <div>
                            <div className="uk-panel">
                                <h4 className="uk-h3 uk-h1@m uk-margin-xsmall uk-margin@m">230+</h4>
                                <span>Creative artists</span>
                            </div>
                        </div>
                        <div>
                            <div className="uk-panel">
                                <h4 className="uk-h3 uk-h1@m uk-margin-xsmall uk-margin@m">2.5x</h4>
