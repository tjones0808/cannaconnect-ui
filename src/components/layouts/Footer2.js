                    ...
                    <div className="uk-grid uk-child-width-1-1@m uk-flex-center uk-text-center" data-uk-grid>
                        <div>
                            <ul className="uk-subnav uk-text-muted uk-flex-center">
                                ...
                                <li><Link href="/src/pages/privacy">Privacy</Link></li>
                                <li><Link href="/src/pages/terms">Terms of use</Link></li>
                                <li><Link href="/src/pages/sign-in">Sign In</Link></li>
                                <li><Link href="/src/pages/sign-up">Sign Up</Link></li>
                            </ul>
                        </div>
                        <div>
                            <Copyright />
