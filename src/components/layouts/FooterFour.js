      ...
      <div className="uk-container">
        <div className="uk-panel uk-position-z-index">
            ...
            <div className="uk-width-expand@m">
              <div className="uk-panel uk-width-medium@m">
                ...
                <ul className="uk-subnav uk-subnav-small">
                  <li>
                    <Link href="https://twitter.com/unistudioco">
                      <i className="uk-icon uk-icon-medium unicon-logo-twitter"></i>
                    </Link>
                  </li>
                  <li>
                    <Link href="https://discord.com/unistudioco">
                      <i className="uk-icon uk-icon-medium unicon-logo-discord"></i>
                    </Link>
                  </li>
                  <li>
                    <Link href="https://instagram.com/unistudioco">
                      <i className="uk-icon uk-icon-medium unicon-logo-instagram"></i>
                    </Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="uk-panel uk-text-small uk-margin-medium-top uk-margin-2xlarge-top@m">
            <div
              className="uk-grid uk-child-width-auto@m uk-flex-between"
              data-uk-grid
            >
              <div>
                <ul className="uk-subnav uk-subnav-small">
